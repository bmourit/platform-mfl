...
#		if board.get("build.mcu").startswith("gd32f103") or board.get("build.mcu").startswith("gd32f303"):
#			# F103 and F303 series don't have embedded DFU over USB
#			# bootloader (v1, v2) is used instead
